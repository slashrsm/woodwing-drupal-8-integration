...
class Drupal7_PubPublishing extends PubPublishing_EnterpriseConnector
{
	...
	public function getPublishFormTemplates( $pubChannelId )
	{
		...
		$contentTypes = $drupalXmlRpcClient->getContentTypes();
			...
			$templatesObj[] = WW_Utils_PublishingUtils::getPublishFormTemplateObj(
				...
				WW_Plugins_Drupal7_Utils::convertContentType2DocumentId( $pubChannelId, $contentType['original'] )
			);
		}
		return $templatesObj;
	}
	...
	public function getDialogForSetPublishPropertiesAction( $publishFormTemplate )
	{
		...
		$contentType = WW_Plugins_Drupal7_Utils::convertDocumentId2ContentType( $basicMD->DocumentID );
	 ...
	 *    /server/plugins/Drupal7/pubchannelicons
	 *
	 * @since 9.0
	 * @return boolean
	 */
